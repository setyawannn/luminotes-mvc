...
<body>
    <div class="font-primary max-w-xs mx-auto w-full min-h-screen flex flex-col p-4">
        <?php if ($data['note']): ?>
            <div class="flex-grow">
                <div class="mt-4">
                    <a href="<?= BASEURL ?>/home" class="flex gap-x-2"><img src="<?= BASEURL ?>/img/icons/arrow-back.svg" alt="arrow-back">Back</a>
                </div>
                <div class="mt-8">
                    ...
                    <div class="flex justify-between items-center mt-6">
                        <div class="flex flex-col justify-start">
                            <div class="flex gap-x-3 items-center">
                                <img class="w-8 h-8 rounded-full object-cover" src="<?= BASEURL ?>/img/person/<?= $data['note']['creator']['img'] ?>" alt="Person <?= $data['note']['creator']['name'] ?>">
                ...
                <div class="mt-4 flex flex-col gap-y-3">
                    <img src="<?= BASEURL ?>/img/thubmnail/<?= $data['note']['thumbnail'] ?>" alt="<?= $data['note']['title'] ?>" class="w-full">
                ...
                <div class="flex flex-col gap-y-2 mt-6">
                    <div class="flex justify-between items-center">
                        ...
                        <?php if (!empty($data['note']['file'])): ?>
                            <a href="<?= BASEURL ?>/files/<?= $data['note']['file'] ?>" download class="p-2 rounded border-2">
                                <img src="<?= BASEURL ?>/img/icons/download.svg" alt="Download">
                            </a>
                            <span class="p-2 text-gray-400">No file</span>
                        <?php endif; ?>
                    </div>
                    <?php if (!empty($data['note']['file'])): ?>
                        <iframe src="<?= BASEURL ?>/files/<?= $data['note']['file'] ?>" frameborder="0" class="w-full h-96 rounded mt-4"></iframe>
                    <?php else: ?>
